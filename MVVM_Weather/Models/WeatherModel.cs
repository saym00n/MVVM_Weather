...
namespace MVVM_Weather
{
    ...
    public class Weather
    {
        ...
        [JsonProperty("main")] public string Title { get; set; }
        ...
        {
            get { return $"https://openweathermap.org/img/w/{IconId}.png"; }
        }
    }
    ...
    public class Main
    {
        ...
        [JsonProperty("feels_like")] public double TemperaturePerception { get; set; }

        [JsonProperty("temp_min")] public double TemperatureMin { get; set; }

        [JsonProperty("temp_max")] public double TemperatureMax { get; set; }

        [JsonProperty("pressure")] public int AtmosphericPressure { get; set; }

        [JsonProperty("humidity")] public int HumidityPercentage { get; set; }
    }
    ...
    public class Clouds
    {
        [JsonProperty("all")] public int Percentage { get; set; }
    }

    public class Rain
    {
        [JsonProperty("1h")] public double? PastHourVolume { get; set; }

        [JsonProperty("3h")] public double? Past3HoursVolume { get; set; }
    }
    ...
    public class Internal
    {
        ...
        [JsonProperty("sunrise")] public long SunriseUnix { get; set; }
        ...
        [JsonProperty("sunset")] public long SunsetUnix { get; set; }
    ...
    {
        [JsonProperty("coord")] public Location Location { get; set; }
        ...
        [JsonProperty("dt")] public long AnalysisDateUnix { get; set; }
        ...
        [JsonProperty("sys")] public Internal Internal { get; set; }

        [JsonProperty("timezone")] public int Timezone { get; set; }

        [JsonProperty("id")] public long CityId { get; set; }

        [JsonProperty("name")] public string CityName { get; set; }

        [JsonProperty("cod")] public int StatusCode { get; set; }
    }
}